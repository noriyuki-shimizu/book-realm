...
useHeadSafe(() => {
  ...
  const description =
    '書籍管理のパスワード再設定画面です。まずメールアドレスを入力し、メールアドレス宛に届いた案内に従って再設定を実施してください。'
  return {
    title,
    meta: [
      ...
      {
        name: 'og:url',
        content: `${runtimeConfig.public.pageBaseUrl}/forgot-password`
      },
      {
        name: 'og:image',
...
<template>
  <PageContentsForgotPasswordContainer />
</template>
